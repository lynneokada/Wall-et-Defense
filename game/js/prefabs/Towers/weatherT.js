function WeatherT(game, x, y, frame, health, ammo, attack, atkrange, atkspeed){
	Tower.call(this, game, x, y, frame, 10, 12, 3, atkrange, 0, atkspeed);
	this.attackSpeed = 100;

	this.ammoText = game.add.text(x+15, y-25, "ammo: " + this.ammo + "/12", {fontSize: '20px', fill: '#ffffff'});
}
...
WeatherT.prototype.update = function(){
	 this.ammoText.text = "ammo: " + this.ammo + "/12";
}
